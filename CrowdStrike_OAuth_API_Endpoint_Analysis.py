...
def query_device(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("query device", parameters=parameters, name="query_device", assets=["cs"], callback=query_device_callback)
...
def create_session(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("create session", parameters=parameters, name="create_session", assets=["cs"], callback=create_session_callback)
...
def run_admin_command_ps(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("run admin command", parameters=parameters, name="run_admin_command_ps", assets=["cs"], callback=process_process_observables)
...
def process_process_observables(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.save_block_result(key="process_process_observables__inputs:0:query_device:action_result.data.*.hostname", value=json.dumps(query_device_result_item_0))
    phantom.save_block_result(key="process_process_observables__inputs:1:run_admin_command_ps:action_result.parameter", value=json.dumps(run_admin_command_ps_result_item_0))
    phantom.save_block_result(key="process_process_observables__inputs:2:run_admin_command_ps:action_result.data", value=json.dumps(run_admin_command_ps_result_item_1))
    phantom.save_block_result(key="process_process_observables__inputs:3:run_admin_command_ps:action_result.status", value=json.dumps(run_admin_command_ps_result_item_2))
    phantom.save_block_result(key="process_process_observables__inputs:4:run_admin_command_ps:action_result.message", value=json.dumps(run_admin_command_ps_result_message))

    phantom.save_block_result(key="process_process_observables:observable_array", value=json.dumps(process_process_observables__observable_array))

    phantom.save_block_result(key="process_process_observables_called", value="True")
...
def run_admin_command_netstat(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("run admin command", parameters=parameters, name="run_admin_command_netstat", assets=["cs"], callback=process_network_observables)
...
def process_network_observables(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.save_block_result(key="process_network_observables__inputs:0:run_admin_command_netstat:action_result.parameter.device_id", value=json.dumps(run_admin_command_netstat_parameter_device_id))
    phantom.save_block_result(key="process_network_observables__inputs:1:query_device:action_result.data.*.hostname", value=json.dumps(query_device_result_item_0))
    phantom.save_block_result(key="process_network_observables__inputs:2:run_admin_command_netstat:action_result.status", value=json.dumps(run_admin_command_netstat_result_item_1))
    phantom.save_block_result(key="process_network_observables__inputs:3:run_admin_command_netstat:action_result.message", value=json.dumps(run_admin_command_netstat_result_message))
    phantom.save_block_result(key="process_network_observables__inputs:4:run_admin_command_netstat:action_result.data", value=json.dumps(run_admin_command_netstat_result_item_3))

    phantom.save_block_result(key="process_network_observables:observable_array", value=json.dumps(process_network_observables__observable_array))

    phantom.save_block_result(key="process_network_observables_called", value="True")
...
def get_system_info(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("get system info", parameters=parameters, name="get_system_info", assets=["cs"], callback=process_system_observables)
...
def process_system_observables(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.save_block_result(key="process_system_observables__inputs:0:get_system_info:action_result.status", value=json.dumps(get_system_info_result_item_0))
    phantom.save_block_result(key="process_system_observables__inputs:1:get_system_info:action_result.message", value=json.dumps(get_system_info_result_message))
    phantom.save_block_result(key="process_system_observables__inputs:2:get_system_info:action_result.data", value=json.dumps(get_system_info_result_item_2))

    phantom.save_block_result(key="process_system_observables:observable_array", value=json.dumps(process_system_observables__observable_array))

    phantom.save_block_result(key="process_system_observables_called", value="True")
...
def join_delete_session(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    required_code_blocks_completed = all([phantom.get_block_result(key=f"{code_block}_called") == "True" for code_block in ["process_process_observables", "process_network_observables", "process_service_observables"]])

    if phantom.completed(code_names=["process_process_observables", "process_network_observables", "process_service_observables"]) and required_code_blocks_completed:
...
def delete_session(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("delete session", parameters=parameters, name="delete_session", assets=["cs"])
...
def run_admin_command_services(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.act("run admin command", parameters=parameters, name="run_admin_command_services", assets=["cs"], callback=process_service_observables)
...
def process_service_observables(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    phantom.save_block_result(key="process_service_observables__inputs:0:query_device:action_result.data.*.device_id", value=json.dumps(query_device_result_item_0))
    phantom.save_block_result(key="process_service_observables__inputs:1:query_device:action_result.data.*.hostname", value=json.dumps(query_device_result_item_1))
    phantom.save_block_result(key="process_service_observables__inputs:2:run_admin_command_services:action_result.data.*.resources", value=json.dumps(run_admin_command_services_result_item_0))
    phantom.save_block_result(key="process_service_observables__inputs:3:run_admin_command_services:action_result.status", value=json.dumps(run_admin_command_services_result_item_1))
    phantom.save_block_result(key="process_service_observables__inputs:4:run_admin_command_services:action_result.message", value=json.dumps(run_admin_command_services_result_message))

    phantom.save_block_result(key="process_service_observables:observable_array", value=json.dumps(process_service_observables__observable_array))

    phantom.save_block_result(key="process_service_observables_called", value="True")
